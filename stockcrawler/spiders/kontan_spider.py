...
class KontanSpider(scrapy.Spider):
    ...
    def parse_content(self, response):
        ...
        judul           = response.xpath('//h1[@class="jdl_dtl"]/text()').extract() if response.xpath('//h1[@class="jdl_dtl"]').get() is not None else response.xpath('//h1[@class="detail_desk"]/text()').extract()
        ...
        tanggal_berita  = response.xpath('//div[@class="fs13 color-gray mar-t-10"]/text()').extract() if response.xpath('//div[@class="fs13 color-gray mar-t-10"]').get() is not None else response.xpath('//div[@class="ffs14 ff-opensans forn-gray"]/text()').extract()
